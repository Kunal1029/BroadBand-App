  ...
  return (
    <Box sx={{ width: "100%" }} className="container-fluid">
        ...
        <div className="goalsabt">
          {value === 0 ? (
            ...
            <div className="text-center">
              <ul>
                <li>
                  Reliability: We prioritize consistent, high-quality
      ...
      <div className="container mt-5 mb-5">
        ...
        <p className="mt-4">
          - Customer-Focused Service: We&#39;re dedicated to supporting you,
          24/7. - Affordable Plans: Quality internet at a price that suits your
          budget. - High-Performance Network: Speeds that keep you connected
          without interruption. - Seamless Installation: Easy setup to get you
