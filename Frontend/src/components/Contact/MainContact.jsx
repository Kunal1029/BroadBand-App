...
function MainContact() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        const enquiryPromise = dispatch(userEnqueries(values)); // Dispatching Redux action
  ...
  return (
    ...
    {/* <!-- Contact --> */}
    <section className="contact d-flex align-items-center cntlap py-5 " id="contact">
    ...
    <section className="contact d-flex align-items-center cntMob " id="contact">
